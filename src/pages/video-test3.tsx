    ...
    <main className='flex justify-center'>
      <div className='relative'>
        {!isPlaying[0] && (
          ...
          <div className="absolute top-0 left-0 w-full h-full z-20 flex items-center justify-center" onClick={handlePlay(0)}>
        ...
        {isPlaying[0] && (
          //サウンド操作のボタン
          <div className="absolute bg-red-500 w-10 h-10 rounded-full right-4 bottom-28 flex items-center justify-center" onClick={handleMute(0)}>
          {isMuted[0] && (
        ...
        <div className='w-[100%] min-w-[300px] min-h-[400px] h-[95vh]'>
          <ReactPlayer
          url={videoUrls[0]}
          playing={isPlaying[0]}
          volume={isVolume[0]}
